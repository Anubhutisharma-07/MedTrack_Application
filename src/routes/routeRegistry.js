...
const WoundCareBurnsHub = lazy(() => import("../pages/woundcare/WoundCareBurnsHub"));
...
export const ROUTES = [
  ...
  { page: "wound-care-burns", slugs: ["wound-care-burns", "wound-management", "burn-center"], component: WoundCareBurnsHub, access: AUTHENTICATED },
