...
export const ROUTES = [
  ...
  { page: "infection-control", slugs: ["infection-control", "infection-control-hub", "antimicrobial-stewardship"], component: InfectionControlStewardshipHub, access: AUTHENTICATED },
